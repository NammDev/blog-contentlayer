...
const Header = () => {
  ...
  return (
    <header className='w-full p-4  px-5 sm:px-10 flex items-center justify-between'>
      ...
      <nav
        className=' w-max py-3 px-6 sm:px-8 border border-solid border-dark rounded-full font-medium capitalize  items-center flex  sm:hidden dark:text-dark
      ...
      <nav
        ...
        fixed top-6 right-1/2 translate-x-1/2 bg-light/80 backdrop-blur-sm z-50 dark:text-dark'
      >
        <Link href='/' className='mr-2'>
          Home
        </Link>
